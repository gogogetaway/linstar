(function () {
  var footerMarkup = [
    ...
    '        <a class="v2-footer-logo" href="index.html" aria-label="Yongxiang home">',
    ...
    '      <p data-i18n="footerDesc">YONGXIANG is a plywood manufacturer and exporter based in Xuzhou, China.</p>',
    '    </div>',
    '  </div>',
    '</footer>'
  ].join("");
